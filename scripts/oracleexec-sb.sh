...
echo /u01/app/oracle/product/12.1.0.2/db_1/oui/bin/runConfig.sh ORACLE_HOME=/u01/app/oracle/product/12.1.0.2/db_1 MODE=perform ACTION=configure RERUN=true $* >/u01/app/oracle/product/12.1.0.2/db_1/cfgtoollogs/configToolAllCommands
chmod 755 /u01/app/oracle/product/12.1.0.2/db_1/cfgtoollogs/configToolAllCommands
...
cp /u01/app/oracle/product/12.1.0.2/db_1/dbs/orapw${PRIMARY_NAME} /u01/app/oracle/product/12.1.0.2/db_1/dbs/orapw${STANDBY_NAME}
#update /etc/oratab with new create instance
echo "${STANDBY_NAME}:/u01/app/oracle/product/12.1.0.2/db_1:N" >>/etc/oratab
